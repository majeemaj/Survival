...
constant integer Table__listK=4
...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'nmrl', 37.6, - 1548.1, 49.517)
endfunction
...
call ExecuteFunc("jasshelper__initstructs68153500")
...
function jasshelper__initstructs68153500 takes nothing returns nothing
