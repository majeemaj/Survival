...
constant integer Table__sizeK=7
...
constant real Wander__DEFAULT_TIMER_TIMEOUT= 1.0
constant string Wander__DEFAULT_ORDER_STRING= "move"
integer Wander__table
...
//==================================================================
    ...
    function Wander__Random takes nothing returns real
        ...
        function s__Wander__staticgetindex takes unit whichUnit returns integer
            return (LoadInteger(Table__ht, (Wander__table), (GetHandleId(whichUnit)))) // INLINED!!
        endfunction
        ...
        function s__Wander_destroy takes integer this returns nothing
            ...
            call RemoveSavedInteger(Table__ht, (Wander__table), (GetHandleId(s__Wander_source[this]))) // INLINED!!
        ...
        function s__Wander_onPeriodic takes nothing returns nothing
            ...
            if UnitAlive(s__Wander_source[this]) then
                ...
                if GetUnitCurrentOrder(s__Wander_source[this]) == 0 and s__Wander_issueWander(this) then
                    ...
                    call TimerStart(s__Wander_tmr[this], Wander__DEFAULT_TIMER_TIMEOUT, true, function s__Wander_onPeriodic)
                endif
            else
        ...
        function s__Wander_create takes unit whichUnit,real range,real cooldown returns integer
            local integer this= (LoadInteger(Table__ht, (Wander__table), (GetHandleId((whichUnit))))) // INLINED!!
            
            if not (s__Wander_tmr[(this)] != null) then // INLINED!!
                set this=s__Wander__allocate()
                set s__Wander_source[this]=whichUnit
                set s__Wander_order[this]=Wander__DEFAULT_ORDER_STRING
                call SaveInteger(Table__ht, (Wander__table), (GetHandleId(whichUnit)), ( this)) // INLINED!!
        ...
        function s__Wander_init takes nothing returns nothing
            set Wander__table=s__Table_create()
        endfunction
//Implemented from module Wander__Init:
        function s__Wander_Wander__Init___onInit takes nothing returns nothing
            set Wander__table=s__Table_create() // INLINED!!
        endfunction
...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'nmrl', 48.2, - 948.4, 49.517)
endfunction
...
// Trigger: onInit
//===========================================================================
function Trig_onInit_Func001A takes nothing returns nothing
    set udg_rng=GetRandomInt(5, 15)
    call s__Wander_create(GetEnumUnit() , 400 , 7)
endfunction

function Trig_onInit_Actions takes nothing returns nothing
    call ForGroupBJ(GetUnitsOfPlayerAll(Player(PLAYER_NEUTRAL_AGGRESSIVE)), function Trig_onInit_Func001A)
endfunction

//===========================================================================
function InitTrig_onInit takes nothing returns nothing
    set gg_trg_onInit=CreateTrigger()
    call TriggerAddAction(gg_trg_onInit, function Trig_onInit_Actions)
endfunction

//===========================================================================
// Trigger: onNew
//===========================================================================
function Trig_onNew_Conditions takes nothing returns boolean
...
function Trig_onNew_Actions takes nothing returns nothing
    set udg_rng=GetRandomInt(5, 15)
    call s__Wander_create(GetTriggerUnit() , 400 , 7)
endfunction

//===========================================================================
function InitTrig_onNew takes nothing returns nothing
    set gg_trg_onNew=CreateTrigger()
    call TriggerRegisterEnterRectSimple(gg_trg_onNew, GetPlayableMapRect())
    call TriggerAddCondition(gg_trg_onNew, Condition(function Trig_onNew_Conditions))
    call TriggerAddAction(gg_trg_onNew, function Trig_onNew_Actions)
endfunction
...
call ExecuteFunc("jasshelper__initstructs413639828")
...
function jasshelper__initstructs413639828 takes nothing returns nothing
...
call ExecuteFunc("s__Wander_Wander__Init___onInit")
